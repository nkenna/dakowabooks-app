...
class AddAuthReviewModal extends StatefulWidget {
  @override
  _AddAuthReviewModalState createState() => _AddAuthReviewModalState();
}

class _AddAuthReviewModalState extends State<AddAuthReviewModal> {
          ...
          builder: (context, aProvider, _){
            return ElevatedButton(
              onPressed: () async{
                ...
                final result = await aProvider.addAuthorReview(
