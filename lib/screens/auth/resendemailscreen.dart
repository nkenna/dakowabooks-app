          ...
          builder: (context, aProvider, _){
            return ElevatedButton(
              onPressed: () async{
                ...
                final result = await aProvider.resendVerificationEmail(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
                ...
                child: Text("Enter your email to receive verification code", style: TextStyle(fontFamily: 'MonumentRegular', fontSize: 16, color: Color(0xff831608)),)
            ),
            SizedBox(height: 30,),
