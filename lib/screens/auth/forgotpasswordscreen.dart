...
import 'package:dakowabook/screens/auth/resetpasswordscreen.dart';
        ...
        child: Consumer<AuthProvider>(
          builder: (context, aProvider, _){
            return ElevatedButton(
              onPressed: () async{
                if(emailController.text.isEmpty || emailController.text.isEmail == false){
                  LoadingControl.showSnackBar("Ouchs!!!", "Please enter valid email address", Icon(Icons.error, color: Colors.white,));
                  return;
                }

                final result = await aProvider.resetPassword(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text("Remember Password? ", style: TextStyle(fontFamily: 'SofiaProRegular', fontSize: 14, color: mainTextColor),),
                        InkWell(
                            onTap: () => Get.to(() => LoginScreen()),
                            child: Text("Sign In", style: TextStyle(fontFamily: 'SofiaProSemiBold', fontSize: 14, color: mainTextColor),)),
                      ],
                    ),
                    ...
                    InkWell(
                        ...
                        child: Text("Create Account", style: TextStyle(fontFamily: 'SofiaProSemiBold', fontSize: 14, color: mainTextColor)))
                  ],
                )
            ),
          ],
