...
class AuthorReviewsScreen extends StatefulWidget {
  @override
  _AuthorReviewsScreenState createState() => _AuthorReviewsScreenState();
}

class _AuthorReviewsScreenState extends State<AuthorReviewsScreen> {
    ...
    scrollController.addListener(() async{
      if(scrollController.position.pixels >= scrollController.position.maxScrollExtent){
        ...
        if(currentPage <= Provider.of<LiteratureProvider>(context, listen: false).authorReviewTotalPages){
          final dd = await Provider.of<LiteratureProvider>(context, listen: false).allAuthorReviews(
              currentPage,
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: Text("${Provider.of<LiteratureProvider>(context, listen: false).selectedAuthor!.firstname} ${Provider.of<LiteratureProvider>(context, listen: false).selectedAuthor!.lastname} 's reviews",
